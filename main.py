...
model = create_model(len(X_train), NUM_FEATURES_1, LAYER1_NEURONS_1, LAYER2_NEURONS_1)
#model = create_model(len(X_train), NUM_FEATURES_2, LAYER1_NEURONS_2, LAYER2_NEURONS_2)
#model = create_model(len(X_train), NUM_FEATURES_3, LAYER1_NEURONS_3, LAYER2_NEURONS_3)
model.summary()
model.compile(
...
if train_model:
    ...
    #model.save_weights('./MODEL/my_model_weights3')
...
if load_model:
    ...
    #model.load_weights('./MODEL/my_model_weights3')
